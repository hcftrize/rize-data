...
ENDPOINTS = {
    ...
    "bond-created":    "https://api.subgraph.ormilabs.com/api/private/a9ede79c-2a5c-4bb8-9208-ac30662368b5/subgraphs/tokerize-bond-created/scraper77/gn",
}
...
ENTITIES = {
    ...
    "bond-timemarker": {
        # Entité réelle : bondTimeMarkerSnapshots (snapshot, pas d'events)
        "bondTimeMarkerSnapshots": "id nftId timeMarker amount poolId blockNumber timestamp",
    },
    "bond-created": {
        # Champs confirmés par introspection directe
